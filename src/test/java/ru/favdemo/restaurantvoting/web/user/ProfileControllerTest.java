...
import static ru.favdemo.restaurantvoting.web.user.ProfileController.REST_URL;
import static ru.favdemo.restaurantvoting.web.user.UniqueMailValidator.EXCEPTION_DUPLICATE_EMAIL;
...
class ProfileControllerTest extends AbstractControllerTest {
    ...
    void delete() throws Exception {
        ...
        USER_MATCHER.assertMatch(userRepository.findAll(), admin, user_vote1, user_vote2);
    }
